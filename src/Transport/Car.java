...
public abstract class Car extends Transport {
    public Car(String brand, String model, int engineVolume, double bestLapTime, int maxSpeed) {
...
//    @Override
//    public void refill() {
//        System.out.println("Данные о заправке " + this.getBrand() + ": " + "Можно заправлять бензином, дизелем на заправке или заряжать на специальных электроду-парковках, если это электрокар");
//    }
